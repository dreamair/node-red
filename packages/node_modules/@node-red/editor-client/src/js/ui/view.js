...
RED.view = (function() {
    ...
    function createIconAttributes(iconUrl, icon_group, d) {
        ...
        const offsetX = d.inputs && !rightAlign ? 4 : d.outputs && rightAlign ? -4 : 0
        if (fontAwesomeUnicode) {
            ...
            node.each(function(d,i) {
                ...
                if (d.dirty) {
                    ...
                    if (d.resize) {
                        var ow = d.w;
                        if (hideLabel) {
                            d.w = node_height + (d.inputs && d.outputs ? 8 : 0);
                        } else {
                    ...
                    if (mouse_mode != RED.state.MOVING_ACTIVE) {
                        ...
                        if ((!d._def.align && d.inputs !== 0 && d.outputs === 0) || "right" === d._def.align) {
                            if (this.__iconGroup__) {
                                ...
                                this.__iconGroup__.setAttribute("transform", "translate("+(d.w-(d.outputs ? 34 : 30))+",0)");
                            }
                            this.__textGroup__.classList.add("red-ui-flow-node-label-right");
                            this.__textGroup__.setAttribute("transform", "translate("+(d.w-38-(d.outputs ? 4 : 0))+","+yp+")");
                        } else {
                            ...
                            this.__textGroup__.classList.remove("red-ui-flow-node-label-right");
                            this.__textGroup__.setAttribute("transform", "translate("+(38 + (d.inputs ? 4 : 0))+","+yp+")");
                        }
                        ...
                        if (d._def.icon) {
                            ...
                            const iconShadeWidth = d.inputs && d.outputs ? hideLabel ? 38 : 34 : 30
